...
def main():
   ...
   for proteinName in ProteinList:
      if proteinName != ['G3HAC6']:
         SequenceFractionMatched.append([proteinName[0],FractionSequenceMatch(proteinName[0])])
         MassFractionMatched.append([proteinName[0],FractionMassMatch(proteinName[0])])
